...
praises = {
    "https://media.giphy.com/media/hMKjvTYlSaFCU/giphy.gif": "gif2",
    "https://media.giphy.com/media/MRxJqmk3MNta8/giphy.gif": "gif2",
    "https://media.giphy.com/media/rFPH6jKnrAKU8/giphy.gif": "gif2",
    "https://media.giphy.com/media/UT2HdKPXukBJjypvwy/giphy.gif": "gif2",
    "https://media.giphy.com/media/83AmaPcShmpjHJ43qC/giphy.gif": "gif2",

    # "wolf of wall street chest bump": "gif",
    # "Satoshi would be proud of us :smiling_face_with_tear:": "string",
    # "Abachi has bigger balls than Jupiter": "string",
    # "(3,3) 4 lyf baby": "string",
    # "Abachi to the moooon. :rocket:": "string",
    # ":913098305012109334:": "string",
    # ":pepe_holding__abachi:": "string",
    # "doge coin dancing": "gif",
    # "can you smell the decentralisation": "gif",
    # "watching my yield": "gif",
    # "austin powers drevil i love you": "gif",
    # "Abachi, You’re that “Nothing” when people ask me what I’m thinking about.": "string",
    # "You look great today ohmie's.": "string",
    # "You have impeccable manners.": "string",
    # "I like your style.": "string",
    # "You have the best laugh.": "string",
    # "I appreciate you.": "string",
    # "You are the most perfect you there is.": "string",
